...
// Императивный код - это набор пошаговых инструкций для машины, который говорит ей, что необходимо сделать (аналог: рецепт приготовления блюда)
// Декларативный код - это указание того, какой результат необходимо получить на выходе (аналог: блюдо из ресторанного меню)
