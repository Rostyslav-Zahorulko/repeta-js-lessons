...
// ІІ. Вызов функции (function invocation)

// Указывается имя переменной, в которую записана ссылка на функцию, и аргументы этой функции.
...
// IV. Псевдомассив arguments и Array.from()
...
// Объявлять переменную arguments не нужно, она существует как ключевое слово
...
// При объявлении параметров функции используется специальная операция rest
// Синтаксис: const имя_переменной = function (...имя_переменной) {}
